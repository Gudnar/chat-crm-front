...
const SVGS = {
  ...
  flow:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><path d="M6.5 10v4a2 2 0 002 2H14M17.5 10v1.5"/></svg>`,
};
...
const ALL_NAV = [
  ...
  { id:'flows',              label:'Flows WA',           route:'flows',              svg: SVGS.flow,      badge: 'NEW', roles: ['SUPER_ADMIN', 'ADMIN_CLIENTE'] },
