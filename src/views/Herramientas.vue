<template>
  ...
  <div v-if="!agenteId" class="ide-mod">
    ...
    <div class="ide-subnav">
      ...
      <div style="font-size:10px; font-weight:700; color:var(--text-disabled); text-transform:uppercase; letter-spacing:1px; padding:0 10px 8px;">Agentes</div>
      ...
      <div v-if="!loadingAgentes && agentes.length === 0" style="font-size:11px; color:var(--text-disabled); padding:8px 12px;">
        No hay agentes
      </div>
    </div>
    ...
    <!-- Content -->
    <div class="ide-body">
      <div v-if="!agenteSeleccionado" style="text-align:center; padding:48px; color:var(--text-disabled);">
